...
class DashboardController extends Controller
{
    ...
    public function companyDashboard()
    {
        ...
        // Obtenir les agences liées à ces entreprises
        $agencyIds = \App\Models\Agency::whereIn('company_id', $companyIds)->pluck('id')->toArray();

            // Compter les utilisateurs membres des entreprises
        $companyUserCount = \DB::table('company_user')
        ->whereIn('company_id', $companyIds)
        ->distinct('user_id')
        ->count('user_id');

        // Compter les utilisateurs membres des agences
        $agencyUserCount = \DB::table('agency_agent')
        ...
        $stats = [
            ...
            'companies' => count($agencyIds),
            'users' => $companyUserCount + $agencyUserCount,
        ...
        $teamMembers = DB::table('company_user')
