...
<?php $__env->startSection('title', 'Entreprise en attente'); ?>
<?php $__env->startSection('header', 'Entreprise en attente d\'approbation'); ?>
...
<main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md transition-all duration-300 hover:shadow-lg animate-slide-up">
        <div class="flex items-center justify-between mb-4">
            ...
            <?php if($company->logo): ?>
                <img src="<?php echo e(asset('storage/' . $company->logo)); ?>" alt="Logo" class="h-12 w-12 rounded-full object-cover border-2 border-gray-200 dark:border-gray-600">
            <?php endif; ?>
        </div>
        ...
        <div class="space-y-3">
            <div class="flex flex-col sm:flex-row">
                ...
                <span class="text-gray-800 dark:text-gray-200"><?php echo e($company->name); ?></span>
            </div>
            <div class="flex flex-col sm:flex-row">
                <span class="text-gray-600 dark:text-gray-400 w-32 font-medium">Email:</span>
                <span class="text-gray-800 dark:text-gray-200"><?php echo e($company->email); ?></span>
            </div>
            <div class="flex flex-col sm:flex-row">
                <span class="text-gray-600 dark:text-gray-400 w-32 font-medium">Téléphone:</span>
                <span class="text-gray-800 dark:text-gray-200"><?php echo e($company->phone); ?></span>
            </div>
            <div class="flex flex-col sm:flex-row">
                <span class="text-gray-600 dark:text-gray-400 w-32 font-medium">Adresse:</span>
                <span class="text-gray-800 dark:text-gray-200">
                    <?php echo e($company->address); ?>, <?php echo e($company->city); ?>, <?php echo e($company->postal_code); ?>, <?php echo e($company->country); ?>

                </span>
            </div>
            <div class="flex flex-col sm:flex-row">
                <span class="text-gray-600 dark:text-gray-400 w-32 font-medium">Description:</span>
                <span class="text-gray-800 dark:text-gray-200"><?php echo e($company->description); ?></span>
            </div>
        </div>

        <div class="mt-6">
            <a href="<?php echo e(route('companies.edit', $company->id)); ?>" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out">
    ...
    <div class="mt-8 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md transition-all duration-300 hover:shadow-lg">
        ...
        <div class="flex">
            ...
            <div class="ml-3">
                ...
                <div class="mt-4">
                    <a href="<?php echo e(route('dashboard')); ?>" class="inline-flex items-center text-sm font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300 transition duration-150 ease-in-out">
...
<?php echo $__env->make('components.back.layout.back', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\VistaResidence\resources\views/companies/pending.blade.php ENDPATH**/ ?>