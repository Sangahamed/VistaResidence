...
<header
    ...
    <nav class="flex gap-8">
        <div class="relative group">
            ...
            <div
                class="absolute left-1/2 z-10 mt-3 w-screen max-w-md -translate-x-1/2 transform px-2 sm:px-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 ease-in-out">
                <div
                    class="overflow-hidden rounded-xl shadow-xl ring-1 ring-black/5 bg-gradient-to-br from-white to-gray-50">
                    <div class="relative grid gap-1 p-2">
                        <div
                            class="group relative flex items-center gap-x-3 rounded-lg p-3 text-sm leading-6 hover:bg-indigo-50/50 transition-colors duration-200">
                            <div
                                class="flex h-9 w-9 flex-none items-center justify-center rounded-lg bg-indigo-50 group-hover:bg-white transition-colors duration-200">
                                <svg class="h-5 w-5 text-indigo-600 group-hover:text-indigo-600 transition-colors duration-200"
                            ...
                            <div class="flex-auto">
                                <a href="#"
                                    class="block font-semibold text-gray-900 group-hover:text-indigo-600 transition-colors duration-200">
                                    Analytics
                    ...
                    <div
                        class="grid grid-cols-2 divide-x divide-gray-200 bg-gradient-to-r from-indigo-50 to-gray-50 rounded-b-xl">
                        <a href="#"
                            class="flex items-center justify-center gap-x-2.5 p-3 text-sm font-semibold leading-6 text-gray-900 hover:bg-indigo-100/50 transition-colors duration-200">
...
$__html = app('livewire')->mount($__name, $__params, 'lw-615613846-0', $__slots ?? [], get_defined_vars());
            ...
            <?php if(auth()->guard()->check()): ?>
                ...
                <button class="flex items-center gap-1 text-gray-900 hover:text-indigo-600 transition-colors duration-300">
                    <img class="h-8 w-8 rounded-full"
                        src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(auth()->user()->name)); ?>&color=7F9CF5&background=EBF4FF"
...
<?php /**PATH C:\xampp\htdocs\VistaResidence\resources\views/components/front/layouts/header.blade.php ENDPATH**/ ?>