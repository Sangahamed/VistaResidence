<div class="relative">
    ...
    >
                ...
                <div class="px-4 py-3 border-b border-gray-100 hover:bg-gray-50">
                    <div class="flex items-start">
                        <div class="flex-shrink-0">
                            <!--[if BLOCK]><![endif]--><?php switch($notification['data']['type'] ?? ''):
                                case ('new_property'): ?>
                                    ...
                                    <?php break; ?>
                                <?php case ('property_status_changed'): ?>
                        ...
                        <div class="ml-3 w-0 flex-1">
                            <a 
                                href="<?php echo e(isset($notification['data']['property_id']) 
        ...
        <div class="py-1 bg-gray-100 rounded-b-md">
            <a href="<?php echo e(route('notifications.index')); ?>" class="block px-4 py-2 text-xs text-center text-blue-600 hover:text-blue-800">
