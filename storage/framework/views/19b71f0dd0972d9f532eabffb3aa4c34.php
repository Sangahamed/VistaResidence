    ...
    <div class="flex flex-col h-screen bg-gray-900 text-white md:flex-row">
        ...
        <div id="sidebar" class="hidden md:block w-80 bg-gray-800 p-6 overflow-y-auto">
            ...
            <form id="map-filters" class="space-y-4">
                ...
                <!-- Prix -->
                <div>
                    <label class="block text-sm font-medium mb-1">Prix (<?php echo e(config('app.currency')); ?>)</label>
                ...
                fetch(`/api/map/properties?${params}`)
                    ...
                    .then(data => {
                        console.log('Propriétés chargées :',
                            data); // Pour déboguer, vérifie la structure des données
                        markerLayer.clearLayers();
                        L.geoJSON(data, {
                            pointToLayer: (feature, latlng) => {
                                // Vérifie et convertis les coordonnées en nombres flottants si nécessaire
...
<?php echo $__env->make('components.front.layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\VistaResidence\resources\views/maps/index.blade.php ENDPATH**/ ?>