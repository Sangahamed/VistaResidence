...
<body class="bg-gray-50 font-sans antialiased">
    <div class="flex h-screen overflow-hidden">
        ...
        <?php if(auth()->user()->isClient() || auth()->user()->isIndividual() || auth()->user()->isCompany() && auth()->user()->hasPendingCompany()): ?>
...
</html><?php /**PATH C:\xampp\htdocs\VistaResidence\resources\views/components/back/layout/back.blade.php ENDPATH**/ ?>