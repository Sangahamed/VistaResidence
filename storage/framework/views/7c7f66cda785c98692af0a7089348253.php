            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="p-6">
                        <div class="flex items-start space-x-4">
                            ...
                            <div class="flex-1 min-w-0">
                                <h3 class="text-xl font-bold text-gray-900 truncate"><?php echo e($property->title); ?></h3>
                                ...
                                <div class="mt-2 flex flex-wrap gap-2">
                                    <span class="px-2 py-1 bg-blue-100 text-blue-800 text-xs font-semibold rounded-full"><?php echo e($property->type); ?></span>
                                    <span class="px-2 py-1 bg-purple-100 text-purple-800 text-xs font-semibold rounded-full"><?php echo e($property->surface); ?> m²</span>
                                    <span class="px-2 py-1 bg-green-100 text-green-800 text-xs font-semibold rounded-full"><?php echo e($property->bedrooms); ?> chambres</span>
                                    <span class="px-2 py-1 bg-amber-100 text-amber-800 text-xs font-semibold rounded-full"><?php echo e(number_format($property->price, 0, ',', ' ')); ?> CFA</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-2xl overflow-hidden transition-all duration-500 animate-fade-in-up">
                    <div class="p-6 sm:p-8">
                        <form action="<?php echo e(isset($property) ? route('visits.store', $property) : route('visits.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="date" id="visit_date" name="visit_date" min="<?php echo e(date('Y-m-d')); ?>" required
                                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-300">
                                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <select id="visit_time_start" name="visit_time_start" required
                                            ...
                                            <?php for($i = 9; $i <= 18; $i++): ?>
                                                <option value="<?php echo e(str_pad($i, 2, '0', STR_PAD_LEFT)); ?>:00"><?php echo e($i); ?>:00</option>
                                            <?php endfor; ?>
                                        </select>
                                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <select id="visit_time_end" name="visit_time_end" required
                                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-300 appearance-none">
                                            <?php for($i = 10; $i <= 19; $i++): ?>
                                                <option value="<?php echo e(str_pad($i, 2, '0', STR_PAD_LEFT)); ?>:00" <?php if($i === 10): ?> selected <?php endif; ?>><?php echo e($i); ?>:00</option>
                                            <?php endfor; ?>
                                        </select>
                                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div class="flex flex-col sm:flex-row gap-4">
                                ...
                                <a href="<?php echo e(isset($property) ? route('properties.show', $property) : route('visits.index')); ?>" 
                ...
                <div class="bg-white rounded-xl shadow-2xl overflow-hidden transition-all duration-300 hover:shadow-xl">
                    ...
                    <div class="p-6">
                        <ul class="space-y-4">
                            ...
                            <?php if(isset($property) && $property && $property->agent): ?>
                            <li class="flex items-start">
                                <div class="flex-shrink-0 h-6 w-6 text-blue-500">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-gray-600">Agent : <?php echo e($property->agent->name); ?></p>
                                    <a href="<?php echo e(route('messenger', ['recipient_id' => $property->agent_id])); ?>" 
...
<?php echo $__env->make('components.front.layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\VistaResidence\resources\views/properties/visits/create.blade.php ENDPATH**/ ?>