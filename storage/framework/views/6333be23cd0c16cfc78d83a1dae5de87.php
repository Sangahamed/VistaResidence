            ...
            <div class="p-6">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-2xl font-semibold text-gray-800 dark:text-white mt-1"><?php echo e($stats['properties_viewed']); ?></p>
                    </div>
            ...
            <div class="p-6">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-2xl font-semibold text-gray-800 dark:text-white mt-1"><?php echo e($stats['favorites_count']); ?></p>
                    </div>
            ...
            <div class="p-6">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-2xl font-semibold text-gray-800 dark:text-white mt-1"><?php echo e($stats['messages_count']); ?></p>
                    </div>
            ...
            <div class="p-6">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-2xl font-semibold text-gray-800 dark:text-white mt-1"><?php echo e($stats['searches_count']); ?></p>
                    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden animate-slide-up">
                ...
                <div class="divide-y divide-gray-100 dark:divide-gray-700">
                    <?php if(count($recentVisits) > 0 || count($messages) > 0): ?>
                        ...
                        <div class="p-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                            <div class="flex items-start">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400">Vous avez visité "<?php echo e($visit->property->title); ?>"</p>
                                </div>
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400">
                                        <?php if($message->sender_id === auth()->id()): ?>
                                            Vous avez envoyé un message à <?php echo e($message->recipient->name); ?>

                                        <?php else: ?>
                                            Vous avez reçu un message de <?php echo e($message->sender->name); ?>
        ...
        <div class="lg:col-span-1">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden animate-slide-up">
                ...
                <div class="divide-y divide-gray-100 dark:divide-gray-700">
                    <?php if(count($savedSearches) > 0): ?>
                        <?php $__currentLoopData = $savedSearches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $search): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-4 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                            <div class="flex justify-between items-start">
                                <div>
                                    <h4 class="text-sm font-medium text-gray-800 dark:text-white"><?php echo e($search->title); ?></h4>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1"><?php echo e($search->criteria); ?></p>
        ...
        <?php if(count($favorites) > 0): ?>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 animate-fade-in">
                    <div class="relative">
                        <img class="w-full h-48 object-cover" src="<?php echo e($favorite->property->featured_image ?? 'https://via.placeholder.com/300x200'); ?>" alt="<?php echo e($favorite->property->title); ?>">
                    ...
                    <div class="p-6">
                        <div class="flex justify-between items-start">
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-white"><?php echo e($favorite->property->title); ?></h3>
                            <span class="inline-block px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200">
                                <?php echo e(number_format($favorite->property->price)); ?> €
                            </span>
                        </div>
                        <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                            ...
                            <?php echo e($favorite->property->location); ?>
                        ...
                        <div class="flex items-center mt-3 text-sm text-gray-500 dark:text-gray-400">
                            <span class="flex items-center mr-4">
                                ...
                                <?php echo e($favorite->property->surface); ?> m²
                            </span>
                            <span class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                                </svg>
                                <?php echo e($favorite->property->bedrooms); ?> ch.
                            </span>
                        </div>
        ...
        <?php else: ?>
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
                <div class="p-8 text-center">
                    ...
                    <div class="mt-6">
                        <a href="<?php echo e(route('properties.index')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 transition-colors duration-200">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                            </svg>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('components.back.layout.back', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\VistaResidence\resources\views/dashboard/client.blade.php ENDPATH**/ ?>