<?php $__env->startSection('pageTitle', isset($pageTitle) ? $pageTitle : 'Create Account'); ?>
    ...
    <section class="min-h-screen flex items-stretch text-white bg-gradient-to-br from-gray-900 to-indigo-900">
        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0 bg-gray-900 bg-opacity-90 backdrop-blur-sm">
            ...
            <div class="w-full py-6 z-20 animate-slide-up">
                ...
                <!-- Registration Form -->
                <form id="registerForm" action="<?php echo e(route('register')); ?>" method="POST" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mt-8 text-center">
                        <p class="text-gray-400">Already have an account? 
                            <a href="<?php echo e(route('login')); ?>" class="text-indigo-400 hover:text-indigo-300 font-medium transition-colors duration-300">Sign in</a>
                        </p>
                    </div>
                </form>
            </div>
...
<?php echo $__env->make('components.front.layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\VistaResidence\resources\views/front/auth/register.blade.php ENDPATH**/ ?>