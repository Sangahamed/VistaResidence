<div x-data="{ activeTab: 'images' }" class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden mb-6 transition-all duration-300 hover:shadow-lg">
        ...
        <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-500 mt-1">Propriété: <?php echo e($property->title); ?></p>
        </div>
            ...
            <div class="border-b border-gray-200">
                <nav class="flex space-x-8">
                    ...
                    <button @click="activeTab = 'videos'; $wire.switchTab('videos')" 
                        ...
                        Vidéos (<?php echo e(count($videos)); ?>)
                    </button>
                </nav>
            </div>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div x-show="activeTab === 'videos'" x-transition>
                                ...
                                <div class="bg-gray-100 p-4 flex items-center justify-between">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm font-medium text-gray-700 truncate">
                                            <?php echo e($video['filename']); ?>

                                        </span>
                                    </div>
                                    <div class="flex space-x-2">
                                        <a href="<?php echo e(Storage::url($video['path'])); ?>" target="_blank"
                ...
                <div class="mb-4">
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['newVideos.*'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> 
...
</div><?php /**PATH C:\xampp\htdocs\VistaResidence\resources\views/livewire/property-media-manager.blade.php ENDPATH**/ ?>