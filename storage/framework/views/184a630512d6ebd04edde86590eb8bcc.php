<div class="max-w-6xl mx-auto p-6">
    ...
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">
            Gestion des médias - <?php echo e($property->title); ?>
    ...
    <div class="mb-6">
        <nav class="flex space-x-8" aria-label="Tabs">
            <button wire:click="switchTab('images')" 
                    class="py-2 px-1 border-b-2 font-medium text-sm <?php echo e($activeTab === 'images' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'); ?>">
                <i class="fas fa-images mr-2"></i>Images (<?php echo e(count($images)); ?>)
            </button>
            <button wire:click="switchTab('videos')" 
                    class="py-2 px-1 border-b-2 font-medium text-sm <?php echo e($activeTab === 'videos' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'); ?>">
                <i class="fas fa-video mr-2"></i>Vidéos (<?php echo e(count($videos)); ?>)
            </button>
            <button wire:click="switchTab('panoramic')" 
                    class="py-2 px-1 border-b-2 font-medium text-sm <?php echo e($activeTab === 'panoramic' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'); ?>">
                <i class="fas fa-panorama mr-2"></i>Images 360° (<?php echo e(count($panoramicImages)); ?>)
            </button>
            <button wire:click="switchTab('virtual-tour')" 
                    class="py-2 px-1 border-b-2 font-medium text-sm <?php echo e($activeTab === 'virtual-tour' ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'); ?>">
                <i class="fas fa-vr-cardboard mr-2"></i>Visite virtuelle
                <!--[if BLOCK]><![endif]--><?php if($hasVirtualTour): ?>
    ...
    <!-- Images Tab -->
    <!--[if BLOCK]><![endif]--><?php if($activeTab === 'images'): ?>
        <div class="space-y-6">
            <!-- Upload Section -->
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                ...
                <!--[if BLOCK]><![endif]--><?php if($uploadInProgress): ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="relative group">
                                ...
                                <div class="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity rounded-lg flex items-center justify-center">
                                    <button wire:click="removeMedia('image', <?php echo e($index); ?>)" 
    ...
    <!-- Videos Tab -->
    <!--[if BLOCK]><![endif]--><?php if($activeTab === 'videos'): ?>
        <div class="space-y-6">
            <!-- Upload Section -->
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">
            ...
            <!-- Videos Grid -->
            <!--[if BLOCK]><![endif]--><?php if(!empty($videos)): ?>
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">
                        Vidéos existantes
                    </h3>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $videos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="relative group">
                                <video class="w-full h-48 object-cover rounded-lg" controls>
                                    <source src="<?php echo e(Storage::url($video['path'])); ?>" type="<?php echo e($video['mime_type']); ?>">
                                    Votre navigateur ne supporte pas la lecture vidéo.
                                </video>
                                <div class="absolute top-2 right-2">
                                    <button wire:click="removeMedia('video', <?php echo e($index); ?>)" 
    ...
    <!-- Panoramic Tab -->
    <!--[if BLOCK]><![endif]--><?php if($activeTab === 'panoramic'): ?>
        <div class="space-y-6">
            <!-- Info Section -->
            ...
            <!--[if BLOCK]><![endif]--><?php if(!empty($panoramicImages)): ?>
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $panoramicImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="relative group">
                                <img src="<?php echo e(Storage::url($image['path'])); ?>" 
                                     alt="Image panoramique <?php echo e($index + 1); ?>" 
                                     class="w-full h-48 object-cover rounded-lg">
                                <div class="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity rounded-lg flex items-center justify-center">
                                    <button wire:click="removeMedia('panoramic', <?php echo e($index); ?>)" 
                                            class="bg-red-600 hover:bg-red-700 text-white p-2 rounded-full">
                                        <i class="fas fa-trash text-sm"></i>
                                    </button>
                                </div>
    ...
    <!-- Virtual Tour Tab -->
    <!--[if BLOCK]><![endif]--><?php if($activeTab === 'virtual-tour'): ?>
        <div class="space-y-6">
            <!-- Current Status -->
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">
                    ...
                    <div class="flex items-center p-4 bg-green-50 dark:bg-green-900 border border-green-200 dark:border-green-700 rounded-lg">
                        ...
                        <div>
                            <p class="text-green-800 dark:text-green-200 font-medium">
                                Visite virtuelle active (<?php echo e(ucfirst($virtualTourType)); ?>)
                            </p>
                            <div class="mt-2 flex space-x-4">
                                <!--[if BLOCK]><![endif]--><?php if($property->slug): ?>
                                    <a href="<?php echo e(route('properties.virtual-tour', $property->slug)); ?>" 
                                       target="_blank"
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(count($panoramicImages) > 0): ?>
...
<?php /**PATH C:\xampp\htdocs\VistaResidence\resources\views/livewire/property-media-manager.blade.php ENDPATH**/ ?>