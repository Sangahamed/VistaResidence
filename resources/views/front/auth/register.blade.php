...
<blade
    section|(%26%2339%3BpageTitle%26%2339%3B%2C%20isset(%24pageTitle)%20%3F%20%24pageTitle%20%3A%20%26%2339%3BPage%20title%20here%26%2339%3B) />
    ...
    <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0"
        ...
        <div class="w-full py-6 z-20">
            ...
            <form action="{{ route('register') }}" method="POST"
                ...
                @csrf
                <div class="pb-2 pt-4">
                    <input type="text" name="name" value="{{ old('name') }}" id="name" placeholder="Nom complet "
                ...
                <div class="pb-2 pt-4">
                    <input type="tel" name="phone" value="{{ old('phone') }}" id="phone" placeholder="Numéro de téléphone"
                        class="block w-full p-4 text-lg rounded-sm bg-black ">
                    @error('phone')
                        <span class="text-red-500 ml-2">{{ $message }}</span>
                    @enderror
                ...
                <div class="pb-2 pt-4">
                    <input type="email" name="email" value="{{ old('email') }}" id="email" placeholder="Adresse e-mail"
                        class="block w-full p-4 text-lg rounded-sm bg-black ">
                    @error('email')
                        <span class="text-red-500 ml-2">{{ $message }}</span>
                    @enderror
                ...
                <div class="pb-2 pt-4">
                    <input class="block w-full p-4 text-lg rounded-sm bg-black " type="password"
                        name="password_confirmation" id="password_confirmation" placeholder="Confirmer le mot de passe">

                    @error('password_confirmation')
                        <span class="text-red-500">{{ $message }}</span>
                    @enderror
                </div>
                <!-- <div class="text-left text-gray-400 hover:text-gray-100">
