        ...
        <div class="w-full py-8 z-20 animate-slide-up">
            ...
            <div class="mb-8 space-y-4">
                ...
                <div class="flex justify-center space-x-4">
                    <a href="{{ route('social.login', 'facebook') }}" class="social-btn transform hover:-translate-y-1 transition-all duration-300">
                    ...
                    <a href="{{ route('social.login', 'google') }}" class="social-btn transform hover:-translate-y-1 transition-all duration-300">
            ...
            <!-- Login Form -->
            <form id="loginForm" action="{{ route('login') }}" method="POST" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                @csrf
                ...
                <div class="mt-8 text-center">
                    <p class="text-gray-400">Don't have an account? 
                        <a href="{{ route('register') }}" class="text-indigo-400 hover:text-indigo-300 font-medium transition-colors duration-300">Sign up</a>
                    </p>
                </div>
            </form>
        </div>
