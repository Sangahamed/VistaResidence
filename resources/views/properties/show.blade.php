            ...
            <div class="w-full lg:w-2/3 space-y-6">
                        ...
                        <div class="absolute bottom-4 left-0 right-0 flex justify-center space-x-2 z-10">
                            @foreach ($property->images as $index => $image)
                                <button @click="goTo({{ $index }})"
                                    :class="{ 'bg-white': currentSlide === {{ $index }}, 'bg-white/50': currentSlide !==
                                            {{ $index }} }"
                ...
                <div class="card hover:scale-[1.01] transition-transform duration-300">
                    ...
                    <div class="card-body grid grid-cols-1 md:grid-cols-2 gap-3">
                        <a href="{{ route('properties.visits.create', $property) }}" class="action-btn-primary group">
            ...
            <div class="w-full lg:w-1/3 space-y-6">
                ...
                <div class="card hover:shadow-lg transition-shadow duration-300">
                    ...
                    <div class="card-body">
                        ...
                        @else
                            <form action="{{ route('properties.startConversation', $property) }}" method="POST" class="space-y-4">
                                @csrf
